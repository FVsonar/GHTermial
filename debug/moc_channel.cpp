...
struct qt_meta_stringdata_CLASSchannelENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSchannelENDCLASS = QtMocHelpers::stringData(
    "channel"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSchannelENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject channel::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSchannelENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSchannelENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSchannelENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *channel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSchannelENDCLASS.stringdata0))
